...
- T08. `leftPad("abc", -1, "-")` → `"abc"`.
- T08. `leftPad("abc", 20, "-")` → `"-----------------abc"`.

## Parâmetro `padStr`

- T05. `leftPad("abc", 5, null)` → `"  abc"`.
- T06. `leftPad("abc", 5, "")` → `"  abc"`.
- T07. `leftPad("abc", 6, "-")` → `"---abc"`.
- T08. `leftPad("abc", 6, "-=")` → `"-=-abc"`.

## Combinação de parâmetros

- T09. `leftPad("abc", 7, "-=")` → `"-=-=abc"`.
- T10. `leftPad("abc", 30, "(O)")` → `"(O)(O)(O)(O)(O)(O)(O)(O)(O)abc"`.
- T11. `leftPad("abc", 28, "(O)")` → `"(O)(O)(O)(O)(O)(O)(O)(O)(abc"`.
...
Não tenho uma ideia interessante para testar aqui